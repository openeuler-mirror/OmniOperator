# 快速入门<a name="ZH-CN_TOPIC_0000002547829893"></a>

## 概述<a name="ZH-CN_TOPIC_0000002515326498"></a>

_快速上手输出的__场景：_

1. _ 需要多个工具或是组件联合实现一个用户场景的操作，需要提供快速上手便于用户能够了解全流程和实现结果。比如mindstudio的多个算子开发工具完成一个算子开发的全流程操作。_
2. _ 用户场景的最简单版本操作，比如pytorch快速上手，提供一个最简化快速上手，使用已经适配好的模型，使用缺省配置，几步操作就可以成功完成迁移，性能已达到最佳。_
...
## 操作步骤<a name="ZH-CN_TOPIC_0000002546886345"></a>
