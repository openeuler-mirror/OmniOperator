...
| charTypeWriteSideCheck |S|Scalar Functions| -                                                                                                                    | NA               | NA           | NA           | NA           | S            | S            | S            | NA           | NA           | S            | NA           | NA            |
| concat_ws              |S|Scalar Functions| -                                                                                                                    | NS               | CS           | CS           | CS           | S            | S            | S            | CS           | CS           | S            | CS           | NS            |
...
| datediff               |S|Scalar Functions| -                                                                                                                    | NA               | NA           | NA           | NA           | CS           | CS           | CS           | S            | NA           | S            | NA           | NA            |
...
| get_json_object        |S|Scalar Functions| -                                                                                                                    | NA                | NA           | NA            | NA           | S            | S            | S            | NA            | NA           | S| NA            | NA            |
...
| least                  |S|Scalar Functions| 仅支持两个入参的情况。                                                                                                          | S                | S            | S            | S            | S            | S            | S            | NS           | S            | S            | S            | NS            |
...
| pmod                   |S|Scalar Functions| -                                                                                                                    | NA               | S            | S            | NS           | NS           | NS           | NS           | NA           | NS           | S            | S            | NA            |
...
- WindowExecTransformer算子目前对Array类型进行了支持，但是只支持row_number和rank，详情见[issue](https://gitcode.com/openeuler/OmniOperator/issues/142)。

- WindowExecTransformer算子不支持聚合函数。

- FileSourceScanExecTransformer算子目前对Array类型进行了支持，但是只支持orc格式，详情见[issue](https://gitcode.com/openeuler/OmniOperator/issues/135)。
