...
| case                   | S                                | Scalar Functions    | omni支持的类型列指示了resultX参数的支持情况                  | S           | S        | S         | S       | S        | S         | S          | S          | S        | S             | S           | S          | S         | S       | S          |
| cast                   | S                                | Scalar Functions    | 详细见OmniCast转换支持表                                     |             |          |           |         |          |           |            |            |          |               |             |            |           |         |            |
...
| concat_ws              | S                                | Scalar Functions    | array类型仅支持array<string>                                 | CS          | CS       | CS        | CS      | CS       | CS        | CS         | S          | CS       | CS            | CS          | NS         | S         | NA      | NA         |
...
| first                  | S                                | Aggregate Functions | omni支持的类型列指示了第一个参数的支持情况                   | S           | S        | S         | S       | S        | S         | S          | S          | S        | S             | S           | S          | S         | S       | S          |
| first_value            | S                                | Aggregate Functions | omni支持的类型列指示了第一个参数的支持情况                   | S           | S        | S         | S       | S        | S         | S          | S          | S        | S             | S           | S          | S         | S       | S          |
...
| if                     | S                                | Scalar Functions    | omni支持的类型列指示了第二、第三个参数的支持情况             | S           | S        | S         | S       | S        | S         | S          | S          | S        | S             | S           | S          | S         | S       | S          |
...
| left                   | S                                | Scalar Functions    | omni支持的类型列指示了第一个参数的支持情况                   | CS          | CS       | CS        | CS      | CS       | CS        | CS         | S          | CS       | CS            | CS          | NS         | NA        | NA      | NA         |
...
| substr                 | S                                | Scalar Functions    | omni支持的类型列指示了第一个参数的支持情况                   | CS          | CS       | CS        | CS      | CS       | CS        | CS         | S          | CS       | CS            | CS          | NS         | NA        | NA      | NA         |
| substring              | S                                | Scalar Functions    | omni支持的类型列指示了第一个参数的支持情况                   | CS          | CS       | CS        | CS      | CS       | CS        | CS         | S          | CS       | CS            | CS          | NS         | NA        | NA      | NA         |
| trunc                  | S                                | Scalar Functions    | omni支持的类型列指示了第一个参数的支持情况                   | NA          | NA       | NA        | NA      | NA       | NA        | NA         | CS         | S        | NS            | NA          | NA         | NA        | NA      | NA         |
...
| regexp                 | S                                | Scalar Functions    | 仅支持第二参数为string常量的情况,右边类型支持性为expr的支持性 | CS          | CS       | CS        | CS      | CS       | CS        | CS         | S          | CS       | CS            | CS          | NS         | NA        | NA      | NA         |
| regexp_like            | S                                | Scalar Functions    | 仅支持第二参数为string常量的情况,右边类型支持性为expr的支持性 | CS          | CS       | CS        | CS      | CS       | CS        | CS         | S          | CS       | CS            | CS          | NS         | NA        | NA      | NA         |
...
| right                  | S                                | Scalar Functions    | omni支持的类型列指示了第一个参数的支持情况                   | CS          | CS       | CS        | CS      | CS       | CS        | CS         | S          | CS       | CS            | CS          | NS         | NA        | NA      | NA         |
| rlike                  | S                                | Scalar Functions    | 仅支持第二参数为string常量的情况,右边类型支持性为expr的支持性 | CS          | CS       | CS        | CS      | CS       | CS        | CS         | S          | CS       | CS            | CS          | NS         | NA        | NA      | NA         |
...
| from_unixtime          | S                                | Scalar Functions    | omni支持的类型列指示了第一个参数的支持情况 omni仅支持format为yyyy-MM-dd和yyyy-MM-dd HH:mm:ss的情况，且时区需要在"GMT+08:00","Asia/Beijing","Asia/Shanghai"之中 | NA          | NS       | CS        | CS      | S        | NS        | CS         | CS         | NA       | NA            | CS          | NA         | NA        | NA      | NA         |
...
| unix_timestamp      | S                                | Scalar Functions    | omni支持的类型指示了第一个参数的支持情况 omni中timeExp仅支持String/Date，format仅支持yyyy-MM-dd和yyyy-MM-dd HH:mm:ss的情况，且时区需要在"GMT+08:00","Asia/Beijing","Asia/Shanghai"之中 | NA          | NA       | NA        | NA      | NA       | NA        | NA         | S          | S        | NS            | NA          | NA         | NA        | NA      | NA         |
...
| date_add            | S                                | Scalar Functions    | omni支持的类型列指示了第一个参数的支持情况, 第二个参数仅支持int类型 | NA          | NA       | NA        | NA      | NA       | NA        | NA         | S          | CS       | CS            | NA          | NA         | NA        | NA      | NA         |
| date_diff           | S                                | Scalar Functions    | -                                                            | NA          | NA       | NA        | NA      | NA       | NA        | NA         | CS         | S        | NS            | NA          | NA         | NA        | NA      | NA         |
| date_format         | S                                | Scalar Functions    | omni支持的类型列指示了第一个参数的支持情况                   | NA          | NA       | NA        | NA      | NA       | NA        | NA         | NS         | CS       | S             | NA          | NA         | NA        | NA      | NA         |
