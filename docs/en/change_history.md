...
<tbody>
  ...
  <tr>
    <td>2025-06-30</td>
    <td>This issue is the tenth official release.</br>Released OmniOperator 1.9.0: </br>Added the Parquet format and columnar write support for Spark 3.3.1, and added support for CentOS 7.9.</td>
  </tr>
  </tbody>
</table>