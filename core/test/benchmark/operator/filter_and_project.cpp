...
protected:
    OperatorFactory *createOperatorFactory(const State &state) override
    {
        ...
        auto exprEvaluator = std::make_shared<ExpressionEvaluator>(filterExpr.at(0), projectionExprs, dataTypes, overflowConfig);
    ...
    std::vector<VectorBatchSupplier> createVecBatch(const State &state) override
    {
        ...
        for (int i = 0; i < totalPositions / PositionsPerPage(state); ++i) {
            if (DictionaryBlocks(state)) {
                vvb[i] = CreateSequenceVectorBatchWithDictionaryVector(INPUT_TYPES[Query(state)],
                    PositionsPerPage(state));
            } else {
...
private:
    ...
    std::map<std::string, std::vector<DataTypePtr>> INPUT_TYPES = {
        ...
        { "q2.1", { CharType(50), CharType(50), VarcharType(50), VarcharType(50), IntType(), IntType(), Decimal128Type(38,2), LongType() } },
        { "q2.2", { LongType(), IntType(), IntType() } },
        { "q2.3", { CharType(50), CharType(50), VarcharType(50), VarcharType(50), IntType(), IntType(), Decimal128Type(38,2), LongType(), Decimal128Type(38,2) } },
        { "q2.4", { CharType(50), CharType(50), VarcharType(50), VarcharType(50), IntType(), Decimal128Type(38,2), Decimal128Type(38,2), LongType() } },
        ...
        { "q8.1", { CharType(50), CharType(50), CharType(50), VarcharType(50), VarcharType(50), IntType(), Decimal128Type(38,2), Decimal128Type(38,2) } },
    ...
    OMNI_BENCHMARK_PARAM(std::string, Query, "q1", "q2", "q3", "q4", "q5", "q6", "q7", "q8", "q9",
        "q10","q1.1","q1.2","q1.3","q2.1", "q2.2", "q2.3", "q2.4", "q3.1", "q3.2", "q3.3", "q3.4", "q4.1", "q4.2",
        "q4.3","q4.4","q4.5","q5.1", "q5.2", "q6.1", "q6.2", "q6.3", "q7.1", "q8.1", "q8.2", "q8.3", "q9.1", "q9.2",
        "q9.3", "q10.1", "q10.2");
