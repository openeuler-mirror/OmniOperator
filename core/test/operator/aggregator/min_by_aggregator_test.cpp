...
TEST(MinByAggregatorTest, ProcessGroupConstTargetIntInt)
{
    MinByAggregatorFactory factory;
    std::vector<int32_t> channels = {0, 1};
    DataTypes inputTypes(std::vector<DataTypePtr>{IntType(), IntType()});
...
TEST(MinByAggregatorTest, ProcessGroupConstKeyIntInt)
{
    MinByAggregatorFactory factory;
    std::vector<int32_t> channels = {0, 1};
    DataTypes inputTypes(std::vector<DataTypePtr>{IntType(), IntType()});
    ...
    // All keys equal (5), last processed row wins with <= -> target = 30
    EXPECT_FALSE(outVec->IsNull(0));
...
TEST(MinByAggregatorTest, ProcessGroupBothConstIntInt)
{
    MinByAggregatorFactory factory;
    std::vector<int32_t> channels = {0, 1};
    DataTypes inputTypes(std::vector<DataTypePtr>{IntType(), IntType()});
...
TEST(MinByAggregatorTest, ProcessGroupConstTargetLongLong)
{
    MinByAggregatorFactory factory;
    std::vector<int32_t> channels = {0, 1};
    DataTypes inputTypes(std::vector<DataTypePtr>{LongType(), LongType()});
...
TEST(MinByAggregatorTest, ProcessGroupConstTargetDoubleDouble)
{
    MinByAggregatorFactory factory;
    std::vector<int32_t> channels = {0, 1};
    DataTypes inputTypes(std::vector<DataTypePtr>{DoubleType(), DoubleType()});
...
TEST(MinByAggregatorTest, ProcessGroupConstTargetIntVarchar)
{
    MinByAggregatorFactory factory;
    std::vector<int32_t> channels = {0, 1};
    DataTypes inputTypes(std::vector<DataTypePtr>{IntType(), VarcharType(10)});
...
TEST(MinByAggregatorTest, ProcessGroupConstVarcharKeyIntVarchar)
{
    MinByAggregatorFactory factory;
    std::vector<int32_t> channels = {0, 1};
    DataTypes inputTypes(std::vector<DataTypePtr>{IntType(), VarcharType(10)});
    ...
    // All keys equal ("xyz"), first processed row wins (equal keys don't update state) -> target = 10
    EXPECT_FALSE(outVec->IsNull(0));
    EXPECT_EQ(static_cast<Vector<int32_t> *>(extractVectors[0])->GetValue(0), 10);
...
TEST(MinByAggregatorTest, ProcessGroupConstTargetVarcharVarchar)
{
    MinByAggregatorFactory factory;
    std::vector<int32_t> channels = {0, 1};
    DataTypes inputTypes(std::vector<DataTypePtr>{VarcharType(10), VarcharType(10)});
