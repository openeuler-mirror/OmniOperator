 ...
 * Description: Unit tests for Max aggregation. Covers INT, LONG, OMNI_BYTE, OMNI_VARBINARY.
 */
...
// ---- Max: Int ----
TEST(MaxAggregatorTest, Int_Basic)
{
    MaxAggregatorFactory factory;
    ...
    EXPECT_EQ(10, resVal->GetValue(0));
...
// ---- Max: Long ----
TEST(MaxAggregatorTest, Long_Basic)
{
    MaxAggregatorFactory factory;
    std::vector<int32_t> ch = {0};
    ...
    EXPECT_FALSE(resVal->IsNull(0));
    EXPECT_EQ(200, resVal->GetValue(0));
...
// ---- Max: Byte (OMNI_BYTE) ----
TEST(MaxAggregatorTest, Byte_Basic)
{
    MaxAggregatorFactory factory;
    std::vector<int32_t> ch = {0};
...
// ---- Max: Varbinary (OMNI_VARBINARY), byte-order ----
TEST(MaxAggregatorTest, Varbinary_Basic)
{
    MaxAggregatorFactory factory;
    std::vector<int32_t> ch = {0};
    ...
    EXPECT_EQ(0, std::memcmp(res.data(), "xyz", 3));
...
// ---- Max: Null input ----
TEST(MaxAggregatorTest, Int_AllNull)
{
    MaxAggregatorFactory factory;
    std::vector<int32_t> ch = {0};
    auto inTypes = AggregatorUtil::WrapWithDataTypes(IntType());
