...
TEST(AggregationOperatorTest, approx_count_distinct_partial_final)
{
...
TEST(AggregationOperatorTest, approx_count_distinct_partial_final_dense)
{
...
TEST(AggregationOperatorTest, approx_count_distinct_partial_final_mixed_sparse_dense)
{
    std::vector<DataTypePtr> aggInputTypes = { LongType() };
    std::vector<DataTypePtr> partialOutputTypes = { VarBinaryType(65536) };
    std::vector<DataTypePtr> finalOutputTypes = { LongType() };
...
TEST(AggregationOperatorTest, approx_count_distinct_partial_final_int)
{
    const int32_t rowCount = 2000;
...
TEST(AggregationOperatorTest, approx_count_distinct_partial_final_boolean)
{
...
TEST(AggregationOperatorTest, approx_count_distinct_partial_final_varchar)
{
    const int32_t rowCount = 2000;
...
TEST(AggregationOperatorTest, approx_count_distinct_partial_final_char)
{
    const int32_t rowCount = 2000;
    const int32_t distinctCount = 500;
    std::vector<std::string> storage(rowCount);
...
TEST(AggregationOperatorTest, approx_count_distinct_partial_final_tinyint)
{
    const int32_t rowCount = 2000;
...
TEST(AggregationOperatorTest, approx_count_distinct_partial_final_smallint)
{
...
TEST(AggregationOperatorTest, approx_count_distinct_partial_final_float)
{
    const int32_t rowCount = 2000;
    const int32_t distinctCount = 1000;
...
TEST(AggregationOperatorTest, approx_count_distinct_partial_final_double)
{
    const int32_t rowCount = 2000;
    const int32_t distinctCount = 1000;
...
TEST(AggregationOperatorTest, approx_count_distinct_partial_final_varbinary)
{
    const int32_t rowCount = 2000;
    const int32_t distinctCount = 500;
    std::vector<std::string> storage(rowCount);
...
TEST(AggregationOperatorTest, approx_count_distinct_partial_final_timestamp)
{
    const int32_t rowCount = 2000;
    const int32_t distinctCount = 1000;
...
TEST(AggregationOperatorTest, approx_count_distinct_partial_final_date32)
{
    const int32_t rowCount = 2000;
    const int32_t distinctCount = 1000;
...
TEST(AggregationOperatorTest, approx_count_distinct_group_by_partial_final)
{
...
TEST(AggregationOperatorTest, approx_count_distinct_with_max_standard_error)
{
    const int32_t rowCount = 2000;
    const int32_t distinctCount = 1000;
