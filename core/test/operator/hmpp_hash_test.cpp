...
TEST(HmppHash, VarcharPerf)
{
    ...
    auto *varcharVectorAddr =
        reinterpret_cast<const varchar *>(VectorHelper::UnsafeGetValues(varcharVector));
    auto *offset = static_cast<int32_t *>(VectorHelper::UnsafeGetOffsetsAddr(varcharVector));
...
TEST(HmppHash, LongPerf)
{
    ...
    HMPPS_Hash_64s(reinterpret_cast<const int64_t *>(VectorHelper::UnsafeGetValues(longVector)),
...
TEST(HmppHash, DoublePerf)
{
    ...
    HMPPS_Hash_64f(reinterpret_cast<const double *>(VectorHelper::UnsafeGetValues(doubleVector)),
...
TEST(HmppHash, Decimal128hashtest)
{
    ...
    auto *decimalAddr =
        reinterpret_cast<const HmppDecimal128 *>(VectorHelper::UnsafeGetValues(decimal128Vector));
...
TEST(HmppHash, IntPerf)
{
    ...
    timer.Reset();
    HMPPS_Hash_32s(reinterpret_cast<const int32_t *>(VectorHelper::UnsafeGetValues(intVector)),
...
TEST(HmppHash, Boolhashtest)
{
    ...
    bool *boolAddr = static_cast<bool *>(VectorHelper::UnsafeGetValues(booleanVector));
...
TEST(HmppHash, VarcharSlicetest)
{
    ...
    auto *varcharSliceVectorAddr =
        reinterpret_cast<const varchar *>(VectorHelper::UnsafeGetValues(varcharSliceVector));
    auto *offset = static_cast<int32_t *>(VectorHelper::UnsafeGetOffsetsAddr(varcharSliceVector));
