...
TEST(ContainerVector, sliceVector)
{
    ...
    std::vector<DataTypePtr> dataTypes = {new DoubleDataType(), new LongDataType() };
...
TEST(ContainerVector, setAndGetValue)
{
    ...
    std::vector<DataTypePtr> VECTOR_TYPES = {new DoubleDataType(), new LongDataType() };
...
TEST(ContainerVector, appendVector)
{
    ...
    std::vector<DataTypePtr> vectorTypes = {new DoubleDataType(), new LongDataType() };
    ...
    std::vector<DataTypePtr> dataTypes2 = {new DoubleDataType(), new LongDataType() };
    ...
    std::vector<DataTypePtr> appendedDataType = {new DoubleDataType(), new LongDataType() };
