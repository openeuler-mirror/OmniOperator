...
TEST(ContainerVector, sliceVector)
{
    ...
    std::vector<DataTypeRawPtr> dataTypes = { new DoubleDataType(), new LongDataType() };
...
TEST(ContainerVector, setAndGetValue)
{
    ...
    std::vector<DataTypeRawPtr> VECTOR_TYPES = { new DoubleDataType(), new LongDataType() };
...
TEST(ContainerVector, appendVector)
{
    ...
    std::vector<DataTypeRawPtr> vectorTypes = { new DoubleDataType(), new LongDataType() };
    ...
    std::vector<DataTypeRawPtr> dataTypes2 = { new DoubleDataType(), new LongDataType() };
    ...
    std::vector<DataTypeRawPtr> appendedDataType = { new DoubleDataType(), new LongDataType() };
