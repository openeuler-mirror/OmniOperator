...
TEST(Decimal128, divide_dividend_smaller_than_divisor)
{
    ...
    Decimal128Wrapper result;
    result = left.Divide(right, 0);
    Decimal128Wrapper expected(0, 29);
...
TEST(Decimal128, positive_dividend_positive_divisor_and_with_scale_factor)
{
    ...
    Decimal128Wrapper expected(0, 755730317481720);
    EXPECT_EQ(result, expected);
}
...
TEST(Decimal128, div_roundup)
{
    ...
    Decimal128Wrapper rValue(0x0, 0x13ba38720);

    Decimal128Wrapper expectValue(0x0, 4453370194541067);
    Decimal128Wrapper result;
...
TEST(Decimal128, div_roundup_2)
{
    ...
    Decimal128Wrapper rValue(0x0000000000000000, 0x0000010473b0c563);

    Decimal128Wrapper expectValue(0x0, 3397145127548828);
    Decimal128Wrapper result;
    result = lValue.Divide(rValue, 0);
    EXPECT_EQ(result, expectValue);
}
...
TEST(Decimal128, DISABLED_div_roundup_3)
{
    ...
    Decimal128Wrapper expectQuotient1(0x0, 0x0);
    ...
    Decimal128Wrapper lValue2(0x0, 0x03);
    Decimal128Wrapper rValue2(0x0, 0xffffffff);
    Decimal128Wrapper expectQuotient2(0x0, 0x0);
    Decimal128Wrapper expectRemainder2(0x0, 0x03);
    bool result2 = AssertDivideAllSign(lValue2, rValue2, 0, 0, expectQuotient2, expectRemainder2);
    EXPECT_EQ(result2, true);

    Decimal128Wrapper lValue3(0x0, 0xffffffff);
    Decimal128Wrapper rValue3(0x0, 0x01);
    Decimal128Wrapper expectQuotient3(0x0, 0xffffffff);
    Decimal128Wrapper expectRemainder3(0x0, 0x00);
    bool result3 = AssertDivideAllSign(lValue3, rValue3, 0, 0, expectQuotient3, expectRemainder3);
    EXPECT_EQ(result3, true);

    Decimal128Wrapper lValue4(0x0, 0xffffffff);
    Decimal128Wrapper rValue4(0x0, 0xffffffff);
    Decimal128Wrapper expectQuotient4(0x0, 0x01);
    Decimal128Wrapper expectRemainder4(0x0, 0x00);
    bool result4 = AssertDivideAllSign(lValue4, rValue4, 0, 0, expectQuotient4, expectRemainder4);
    EXPECT_EQ(result4, true);

    Decimal128Wrapper lValue5(0x0, 0xffffffff);
    Decimal128Wrapper rValue5(0x0, 0x03);
    Decimal128Wrapper expectQuotient5(0x0, 0x55555555);
    Decimal128Wrapper expectRemainder5(0x0, 0x00);
    bool result5 = AssertDivideAllSign(lValue5, rValue5, 0, 0, expectQuotient5, expectRemainder5);
    EXPECT_EQ(result5, true);

    // 18446744073709551615/4294967295
    Decimal128Wrapper lValue6(0x0, 0xffffffffffffffff);
    Decimal128Wrapper rValue6(0x0, 0xffffffff);
    Decimal128Wrapper expectQuotient6(0x0, 0x100000001);
    Decimal128Wrapper expectRemainder6(0x0, 0x00);
    ...
    Decimal128Wrapper lValue7(0x0, 0xfffffffeffffffff);
    Decimal128Wrapper rValue7(0x0, 0xffffffff);
    Decimal128Wrapper expectQuotient7(0x0, 0xffffffff);
    Decimal128Wrapper expectRemainder7(0x0, 0xfffffffe);
    ...
    Decimal128Wrapper lValue8(0x0, 0x0000123400005678);
    Decimal128Wrapper rValue8(0x0, 0x00009abc);
    Decimal128Wrapper expectQuotient8(0x0, 0x1e1dba76);
    Decimal128Wrapper expectRemainder8(0x0, 0x6bd0);
    ...
    Decimal128Wrapper lValue9(0x0, 0x700000000);
    Decimal128Wrapper rValue9(0x0, 0x300000000);
    Decimal128Wrapper expectQuotient9(0x0, 0x02);
    Decimal128Wrapper expectRemainder9(0x0, 0x100000000);
    ...
    Decimal128Wrapper lValue10(0x0, 0x700000005);
    Decimal128Wrapper rValue10(0x0, 0x300000000);
    Decimal128Wrapper expectQuotient10(0x0, 0x02);
    Decimal128Wrapper expectRemainder10(0x0, 0x100000005);
    ...
    Decimal128Wrapper lValue11(0x0, 0x600000000);
    Decimal128Wrapper rValue11(0x0, 0x200000000);
    Decimal128Wrapper expectQuotient11(0x0, 0x03);
    Decimal128Wrapper expectRemainder11(0x0, 0x00);
    ...
    Decimal128Wrapper lValue12(0x0, 0x80000000);
    Decimal128Wrapper rValue12(0x0, 0x40000001);
    Decimal128Wrapper expectQuotient12(0x0, 0x01);
    Decimal128Wrapper expectRemainder12(0x0, 0x3fffffff);
    ...
    Decimal128Wrapper lValue13(0x0, 0x8000000000000000);
    Decimal128Wrapper rValue13(0x0, 0x40000001);
    Decimal128Wrapper expectQuotient13(0x0, 0x1fffffff8);
    Decimal128Wrapper expectRemainder13(0x0, 0x08);
    ...
    Decimal128Wrapper lValue14(0x0, 0x8000000000000000);
    Decimal128Wrapper rValue14(0x0, 0x4000000000000001);
    Decimal128Wrapper expectQuotient14(0x0, 0x01);
    Decimal128Wrapper expectRemainder14(0x0, 0x3fffffffffffffff);
    ...
    Decimal128Wrapper lValue15(0x0, 0x0000bcde0000789a);
    Decimal128Wrapper rValue15(0x0, 0x0000bcde0000789a);
    Decimal128Wrapper expectQuotient15(0x0, 0x01);
    Decimal128Wrapper expectRemainder15(0x0, 0x00);
    ...
    Decimal128Wrapper lValue16(0x0, 0x0000bcde0000789b);
    Decimal128Wrapper rValue16(0x0, 0x0000bcde0000789a);
    Decimal128Wrapper expectQuotient16(0x0, 0x01);
    Decimal128Wrapper expectRemainder16(0x0, 0x01);
    ...
    Decimal128Wrapper lValue17(0x0, 0x0000bcde00007899);
    Decimal128Wrapper rValue17(0x0, 0x0000bcde0000789a);
    Decimal128Wrapper expectQuotient17(0x0, 0x00);
    Decimal128Wrapper expectRemainder17(0x0, 0x0000bcde00007899);
    ...
    Decimal128Wrapper lValue18(0x0, 0x0000ffff0000ffff);
    Decimal128Wrapper rValue18(0x0, 0x0000ffff0000ffff);
    Decimal128Wrapper expectQuotient18(0x0, 0x01);
    Decimal128Wrapper expectRemainder18(0x0, 0x00);
    ...
    Decimal128Wrapper lValue19(0x0, 0x0000ffff0000ffff);
    Decimal128Wrapper rValue19(0x0, 0x0000ffff00000000);
    Decimal128Wrapper expectQuotient19(0x0, 0x01);
    Decimal128Wrapper expectRemainder19(0x0, 0xffff);
    ...
    Decimal128Wrapper rValue20(0x0, 0x100000000);
    Decimal128Wrapper expectQuotient20(0x0, 0x12300004567);
    Decimal128Wrapper expectRemainder20(0x0, 0x89ab);
    ...
    Decimal128Wrapper rValue21(0x0, 0x80000000ffff);
    Decimal128Wrapper expectQuotient21(0x0, 0xffffffff);
    Decimal128Wrapper expectRemainder21(0x0, 0x7fff0000ffff);
    ...
    Decimal128Wrapper expectQuotient22(0x0, 0x03);
    ...
    Decimal128Wrapper expectQuotient23(0x0, 0x03);
    ...
    Decimal128Wrapper expectQuotient24(0x0, 0xfffe0000);
    ...
    Decimal128Wrapper expectQuotient25(0x0, 0xffffffff);
    ...
    Decimal128Wrapper expectQuotient28(0x0, 0x00);
    ...
    Decimal128Wrapper expectQuotient29(0x0, 0x00);
    ...
    Decimal128Wrapper expectQuotient30(0x0, 0x01);
    ...
    Decimal128Wrapper expectQuotient31(0x0, 0x0a);
    ...
    Decimal128Wrapper expectQuotient32(0x0, 0x0a);
    Decimal128Wrapper expectRemainder32(0x0, 0x00);
...
{
    // 0 + 0 = 0
    Decimal128Wrapper lValue1(0x0, 0x0);
    Decimal128Wrapper rValue1(0x0, 0x0);
    ...
    Decimal128Wrapper rValue2(0x0, 0x0);
    Decimal128Wrapper result2;
    result2 = lValue2.Add(rValue2);
    EXPECT_EQ(Decimal128Wrapper(0x0, 0x1), result2);

    // 1 + 1 = 2
    Decimal128Wrapper lValue3(0x0, 0x1);
    Decimal128Wrapper rValue3(0x0, 0x1);
    Decimal128Wrapper result3;
    result3 = lValue3.Add(rValue3);
    EXPECT_EQ(Decimal128Wrapper(0x0, 0x2), result3);

    // 4294967296 + 0 = 4294967296
    Decimal128Wrapper lValue4(0x0, 0x100000000);
    Decimal128Wrapper rValue4(0x0, 0x0);
    Decimal128Wrapper result4;
    result4 = lValue4.Add(rValue4);
    EXPECT_EQ(Decimal128Wrapper(0x0, 0x100000000), result4);

    // 2147483648 + 2147483648 = 4294967296
    Decimal128Wrapper lValue5(0x0, 0x80000000);
    Decimal128Wrapper rValue5(0x0, 0x80000000);
    Decimal128Wrapper result5;
    result5 = lValue5.Add(rValue5);
    EXPECT_EQ(Decimal128Wrapper(0x0, 0x100000000), result5);

    // 4294967296 + 8589934592 = 12884901888
    Decimal128Wrapper lValue6(0x0, 0x100000000);
    Decimal128Wrapper rValue6(0x0, 0x200000000);
...
TEST(Decimal128, addReturnOverflow)
{
    Decimal128Wrapper result;
    // 2 + 2
    Decimal128Wrapper lValue1(0x0, 0x2);
    Decimal128Wrapper rValue1(0x0, 0x2);
    ...
    Decimal128Wrapper rValue6(0x0, 0x1);
...
TEST(Decimal128, multiply)
{
    ...
    Decimal128Wrapper lValue6(0x0, 0xFFFFFFFFFFFFFFFF);
    Decimal128Wrapper rValue6(0x0, 0xFFFFFFFFFFFFFF);
    Decimal128Wrapper result6;
    ...
    Decimal128Wrapper lValue7(0x0, 0xFFFFFF0096BFB800);
    Decimal128Wrapper rValue7(0x0, 0x39003539D9A51600);
    ...
    Decimal128Wrapper rValue10(0x0, 0x3);
...
TEST(Decimal128, multiplyByInt)
{
    // 0 * 1 = 0
    Decimal128Wrapper lValue1(0x0, 0x0);
    Decimal128Wrapper rValue1(0x0, 0x1);
    Decimal128Wrapper result1;
    result1 = lValue1.Multiply(rValue1);
    EXPECT_EQ(Decimal128Wrapper(0x0, 0x0), result1);

    // 2 * Integer.MAX_VALUE = 4294967294
    Decimal128Wrapper lValue2(0x0, 0x2);
    Decimal128Wrapper rValue2(0x0, 0x7FFFFFFF);
    Decimal128Wrapper result2;
    result2 = lValue2.Multiply(rValue2);
    EXPECT_EQ(Decimal128Wrapper(0x0, 0xFFFFFFFE), result2);
    ...
    Decimal128Wrapper rValue5(0x0, 0x2);
    Decimal128Wrapper result5;
    result5 = lValue5.Multiply(rValue5);
...
TEST(Decimal128, multiplyOverflow)
{
    ...
    // MAX_DECIMAL * 10
    Decimal128Wrapper lValue2(0x4B3B4CA85A86C47A, 0x98A223FFFFFFFFF);
    Decimal128Wrapper rValue2(0x0, 0xA);
    Decimal128Wrapper result2;
    result2 = lValue2.Multiply(rValue2);
    EXPECT_EQ(result1.IsOverflow(), OpStatus::OP_OVERFLOW);
}
...
{
    // 10  (0) = 10
    Decimal128Wrapper value1(0x0, 0xA);
    Decimal128Wrapper result1;
    result1 = value1.ReScale(0);
    EXPECT_EQ(Decimal128Wrapper(0x0, 0xA), result1);

    // 15  (-1) = 2
    Decimal128Wrapper value3(0x0, 0xF);
    Decimal128Wrapper result3;
    result3 = value3.ReScale(-1);
    EXPECT_EQ(Decimal128Wrapper(0x0, 0x2), result3);

    // 1050  (-3) = 1
    Decimal128Wrapper value4(0x0, 0x41A);
    Decimal128Wrapper result4;
    result4 = value4.ReScale(-3);
    EXPECT_EQ(Decimal128Wrapper(0x0, 0x1), result4);

    // 15  (1) = 150
    Decimal128Wrapper value5(0x0, 0xF);
    Decimal128Wrapper result5;
    ...
    EXPECT_EQ(Decimal128Wrapper(0x0, 0x0), result8);

    // 5  (-1) = 1
    Decimal128Wrapper value9(0x0, 0x5);
    Decimal128Wrapper result9;
    result9 = value9.ReScale(-1);
    EXPECT_EQ(Decimal128Wrapper(0x0, 0x1), result9);

    // 10  (10) = 100000000000
    Decimal128Wrapper value10(0x0, 0xA);
    Decimal128Wrapper result10;
    result10 = value10.ReScale(10);
    EXPECT_EQ(Decimal128Wrapper(0x0, 0x174876E800), result10);
    ...
    EXPECT_EQ(Decimal128Wrapper(0x0, 0x9), result16);

    // 4611686018427387904  (-18) = 5
    Decimal128Wrapper value17(0x0, 0x4000000000000000);
    Decimal128Wrapper result17;
    result17 = value17.ReScale(-18);
    EXPECT_EQ(Decimal128Wrapper(0x0, 0x5), result17);
...
TEST(Decimal128, DISABLED_rescaleGT18)
{
    ...
    EXPECT_EQ(Decimal128Wrapper(0x0, 0x0), result2);
    ...
    EXPECT_EQ(Decimal128Wrapper(0x0, 0x2), result11);
    ...
    EXPECT_EQ(Decimal128Wrapper(0x0, 0x1), result13);

    // 4611686018427387904  (-19) = 0
    Decimal128Wrapper value18(0x0, 0x4000000000000000);
    Decimal128Wrapper result18;
    result18 = value18.ReScale(-19);
    EXPECT_EQ(Decimal128Wrapper(0x0, 0x0), result18);

    // 1  (37) = 10000000000000000000000000000000000000
    Decimal128Wrapper value21(0x0, 0x1);
