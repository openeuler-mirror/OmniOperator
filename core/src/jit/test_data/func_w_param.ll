; ModuleID = 'func_w_param.cpp'
source_filename = "func_w_param.cpp"
...
define dso_local i32 @_Z7processPiS_i(i32* nocapture readonly %row_data, i32* nocapture readonly %y, i32 %z) local_unnamed_addr #0 {
entry:
...
if.end16.sink.split:                              ; preds = %for.body
  ...
  %add = add nsw i32 %4, %sum.040
  br label %if.end16

if.end16:                                         ; preds = %for.body, %if.end16.sink.split
  %sum.2 = phi i32 [ %sum.040, %for.body ], [ %add, %if.end16.sink.split ]
  %call17 = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([8 x i8], [8 x i8]* @.str.2, i64 0, i64 0), i32 %sum.2)
