; ModuleID = 'perf_test.cpp'
source_filename = "perf_test.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_perf_test.cpp, i8* null }]
...
; Function Attrs: nounwind uwtable mustprogress
define dso_local i32 @_Z9perf_testi(i32 %count) local_unnamed_addr #3 {
entry:
  ...
  %vla2 = alloca i32, i64 %0, align 16
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %vec.ind42 = phi <4 x i32> [ <i32 0, i32 1, i32 2, i32 3>, %vector.ph ], [ %vec.ind.next45, %vector.body ]
  %vec.ind46 = phi <4 x i32> [ <i32 0, i32 1, i32 2, i32 3>, %vector.ph ], [ %vec.ind.next49, %vector.body ]
  %1 = getelementptr inbounds i32, i32* %vla, i64 %index
  %step.add43 = add <4 x i32> %vec.ind42, <i32 4, i32 4, i32 4, i32 4>
  %2 = bitcast i32* %1 to <4 x i32>*
  store <4 x i32> %vec.ind42, <4 x i32>* %2, align 16, !tbaa !2
  %3 = getelementptr inbounds i32, i32* %1, i64 4
  %4 = bitcast i32* %3 to <4 x i32>*
  store <4 x i32> %step.add43, <4 x i32>* %4, align 16, !tbaa !2
  %5 = getelementptr inbounds i32, i32* %vla1, i64 %index
  %6 = shl <4 x i32> %vec.ind46, <i32 1, i32 1, i32 1, i32 1>
  %step.add47 = shl <4 x i32> %vec.ind46, <i32 1, i32 1, i32 1, i32 1>
  %7 = add <4 x i32> %step.add47, <i32 8, i32 8, i32 8, i32 8>
  %8 = bitcast i32* %5 to <4 x i32>*
  store <4 x i32> %6, <4 x i32>* %8, align 16, !tbaa !2
  %9 = getelementptr inbounds i32, i32* %5, i64 4
  %10 = bitcast i32* %9 to <4 x i32>*
  store <4 x i32> %7, <4 x i32>* %10, align 16, !tbaa !2
  %11 = mul nsw <4 x i32> %vec.ind42, <i32 3, i32 3, i32 3, i32 3>
  %12 = mul nsw <4 x i32> %step.add43, <i32 3, i32 3, i32 3, i32 3>
  %13 = getelementptr inbounds i32, i32* %vla2, i64 %index
  %14 = bitcast i32* %13 to <4 x i32>*
  store <4 x i32> %11, <4 x i32>* %14, align 16, !tbaa !2
  %15 = getelementptr inbounds i32, i32* %13, i64 4
  %16 = bitcast i32* %15 to <4 x i32>*
  store <4 x i32> %12, <4 x i32>* %16, align 16, !tbaa !2
  %index.next = add i64 %index, 8
  %vec.ind.next45 = add <4 x i32> %vec.ind42, <i32 8, i32 8, i32 8, i32 8>
  %vec.ind.next49 = add <4 x i32> %vec.ind46, <i32 8, i32 8, i32 8, i32 8>
  %17 = icmp eq i64 %index.next, %n.vec
  br i1 %17, label %middle.block, label %vector.body, !llvm.loop !16

middle.block:                                     ; preds = %vector.body
  %cmp.n = icmp eq i64 %n.vec, %0
  br i1 %cmp.n, label %for.cond.cleanup, label %for.body.preheader50
...
for.cond.cleanup:                                 ; preds = %for.body, %middle.block, %entry
  %18 = bitcast [3 x i8*]* %columns to i8*
  ...
  %19 = bitcast [3 x i8*]* %columns to i32**
  store i32* %vla, i32** %19, align 16, !tbaa !11
  %arrayinit.element = getelementptr inbounds [3 x i8*], [3 x i8*]* %columns, i64 0, i64 1
  %20 = bitcast i8** %arrayinit.element to i32**
  store i32* %vla1, i32** %20, align 8, !tbaa !11
  %arrayinit.element8 = getelementptr inbounds [3 x i8*], [3 x i8*]* %columns, i64 0, i64 2
  %21 = bitcast i8** %arrayinit.element8 to i32**
  store i32* %vla2, i32** %21, align 16, !tbaa !11
  %22 = bitcast [3 x i32]* %column_type to i8*
  call void @llvm.lifetime.start.p0i8(i64 12, i8* nonnull %22) #10
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 4 dereferenceable(12) %22, i8* nonnull align 4 dereferenceable(12) bitcast ([3 x i32]* @__const.main.column_type to i8*), i64 12, i1 false)
  br i1 %cmp37, label %for.body13.lr.ph, label %for.cond.cleanup12

for.body13.lr.ph:                                 ; preds = %for.cond.cleanup
  %arraydecay14 = getelementptr inbounds [3 x i32], [3 x i32]* %column_type, i64 0, i64 0
  br label %for.body13
...
for.body:                                         ; preds = %for.body.preheader50, %for.body
  ...
  store i32 %23, i32* %arrayidx, align 4, !tbaa !2
  %arrayidx4 = getelementptr inbounds i32, i32* %vla1, i64 %indvars.iv
  %indvars.iv.tr = trunc i64 %indvars.iv to i32
  %24 = shl i32 %indvars.iv.tr, 1
  store i32 %24, i32* %arrayidx4, align 4, !tbaa !2
  %mul5 = mul nsw i32 %23, 3
  %arrayidx7 = getelementptr inbounds i32, i32* %vla2, i64 %indvars.iv
  store i32 %mul5, i32* %arrayidx7, align 4, !tbaa !2
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond40.not = icmp eq i64 %indvars.iv.next, %0
  br i1 %exitcond40.not, label %for.cond.cleanup, label %for.body, !llvm.loop !18
...
for.body13:                                       ; preds = %for.body13.lr.ph, %for.body13
  %i9.036 = phi i32 [ 0, %for.body13.lr.ph ], [ %inc16, %for.body13 ]
  %call = call double @_Z7processPPvPiii(i8** nonnull %arrayinit.begin, i32* nonnull %arraydecay14, i32 3, i32 %count)
  %inc16 = add nuw nsw i32 %i9.036, 1
  %exitcond.not = icmp eq i32 %inc16, %count
  br i1 %exitcond.not, label %for.cond.cleanup12, label %for.body13, !llvm.loop !20
}
...
entry:
  %columns = alloca [3 x i8*], align 16
  %column_type = alloca [3 x i32], align 4
  %vla50 = alloca [10000 x i32], align 16
  %vla151 = alloca [10000 x i32], align 16
  %vla252 = alloca [10000 x i32], align 16
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %entry
  %index = phi i64 [ 0, %entry ], [ %index.next, %vector.body ]
  %vec.ind67 = phi <4 x i32> [ <i32 0, i32 1, i32 2, i32 3>, %entry ], [ %vec.ind.next70, %vector.body ]
  %vec.ind71 = phi <4 x i32> [ <i32 0, i32 1, i32 2, i32 3>, %entry ], [ %vec.ind.next74, %vector.body ]
  %vec.ind75 = phi <4 x i32> [ <i32 0, i32 1, i32 2, i32 3>, %entry ], [ %vec.ind.next78, %vector.body ]
  %0 = getelementptr inbounds [10000 x i32], [10000 x i32]* %vla50, i64 0, i64 %index
  %step.add68 = add <4 x i32> %vec.ind67, <i32 4, i32 4, i32 4, i32 4>
  %1 = bitcast i32* %0 to <4 x i32>*
  store <4 x i32> %vec.ind67, <4 x i32>* %1, align 16, !tbaa !2
  %2 = getelementptr inbounds i32, i32* %0, i64 4
  %3 = bitcast i32* %2 to <4 x i32>*
  store <4 x i32> %step.add68, <4 x i32>* %3, align 16, !tbaa !2
  %4 = getelementptr inbounds [10000 x i32], [10000 x i32]* %vla151, i64 0, i64 %index
  %5 = shl <4 x i32> %vec.ind71, <i32 1, i32 1, i32 1, i32 1>
  %step.add72 = shl <4 x i32> %vec.ind71, <i32 1, i32 1, i32 1, i32 1>
  %6 = add <4 x i32> %step.add72, <i32 8, i32 8, i32 8, i32 8>
  %7 = bitcast i32* %4 to <4 x i32>*
  store <4 x i32> %5, <4 x i32>* %7, align 16, !tbaa !2
  %8 = getelementptr inbounds i32, i32* %4, i64 4
  %9 = bitcast i32* %8 to <4 x i32>*
  store <4 x i32> %6, <4 x i32>* %9, align 16, !tbaa !2
  %10 = getelementptr inbounds [10000 x i32], [10000 x i32]* %vla252, i64 0, i64 %index
  %11 = mul <4 x i32> %vec.ind75, <i32 3, i32 3, i32 3, i32 3>
  %12 = mul <4 x i32> %vec.ind75, <i32 3, i32 3, i32 3, i32 3>
  %13 = add <4 x i32> %12, <i32 12, i32 12, i32 12, i32 12>
  %14 = bitcast i32* %10 to <4 x i32>*
  store <4 x i32> %11, <4 x i32>* %14, align 16, !tbaa !2
  %15 = getelementptr inbounds i32, i32* %10, i64 4
  %16 = bitcast i32* %15 to <4 x i32>*
  store <4 x i32> %13, <4 x i32>* %16, align 16, !tbaa !2
  %index.next = add i64 %index, 8
  %vec.ind.next70 = add <4 x i32> %vec.ind67, <i32 8, i32 8, i32 8, i32 8>
  %vec.ind.next74 = add <4 x i32> %vec.ind71, <i32 8, i32 8, i32 8, i32 8>
  %vec.ind.next78 = add <4 x i32> %vec.ind75, <i32 8, i32 8, i32 8, i32 8>
  %17 = icmp eq i64 %index.next, 10000
  br i1 %17, label %for.cond.cleanup, label %vector.body, !llvm.loop !21

for.cond.cleanup:                                 ; preds = %vector.body
  %18 = bitcast [3 x i8*]* %columns to i8*
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %18) #10
  %arrayinit.begin = getelementptr inbounds [3 x i8*], [3 x i8*]* %columns, i64 0, i64 0
  %19 = bitcast [3 x i8*]* %columns to [10000 x i32]**
  store [10000 x i32]* %vla50, [10000 x i32]** %19, align 16, !tbaa !11
  %arrayinit.element = getelementptr inbounds [3 x i8*], [3 x i8*]* %columns, i64 0, i64 1
  %20 = bitcast i8** %arrayinit.element to [10000 x i32]**
  store [10000 x i32]* %vla151, [10000 x i32]** %20, align 8, !tbaa !11
  %arrayinit.element8 = getelementptr inbounds [3 x i8*], [3 x i8*]* %columns, i64 0, i64 2
  %21 = bitcast i8** %arrayinit.element8 to [10000 x i32]**
  store [10000 x i32]* %vla252, [10000 x i32]** %21, align 16, !tbaa !11
  %22 = bitcast [3 x i32]* %column_type to i8*
  call void @llvm.lifetime.start.p0i8(i64 12, i8* nonnull %22) #10
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 4 dereferenceable(12) %22, i8* nonnull align 4 dereferenceable(12) bitcast ([3 x i32]* @__const.main.column_type to i8*), i64 12, i1 false)
  %call = call i64 @_ZNSt6chrono3_V212system_clock3nowEv() #10
  %arraydecay15 = getelementptr inbounds [3 x i32], [3 x i32]* %column_type, i64 0, i64 0
  br label %for.body14

for.cond.cleanup13:                               ; preds = %for.body14
  %call20 = call i64 @_ZNSt6chrono3_V212system_clock3nowEv() #10
  %sub.i.i = sub nsw i64 %call20, %call
  ...
  %call1.i54 = call nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(%"class.std::basic_ostream"* nonnull align 8 dereferenceable(8) @_ZSt4cout, i8* nonnull getelementptr inbounds ([17 x i8], [17 x i8]* @.str, i64 0, i64 0), i64 16)
  %call.i = call nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSo9_M_insertIlEERSoT_(%"class.std::basic_ostream"* nonnull dereferenceable(8) @_ZSt4cout, i64 %conv.i.i)
  %call1.i = call nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(%"class.std::basic_ostream"* nonnull align 8 dereferenceable(8) %call.i, i8* nonnull getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i64 0, i64 0), i64 3)
  %call31 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([12 x i8], [12 x i8]* @.str.2, i64 0, i64 0), double %call16)
  call void @llvm.lifetime.end.p0i8(i64 12, i8* nonnull %22) #10
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %18) #10
  ret i32 0

for.body14:                                       ; preds = %for.cond.cleanup, %for.body14
  %i10.061 = phi i32 [ 0, %for.cond.cleanup ], [ %inc18, %for.body14 ]
  %call16 = call double @_Z7processPPvPiii(i8** nonnull %arrayinit.begin, i32* nonnull %arraydecay15, i32 3, i32 10000)
  %inc18 = add nuw nsw i32 %i10.061, 1
  %exitcond.not = icmp eq i32 %inc18, 10000
  br i1 %exitcond.not, label %for.cond.cleanup13, label %for.body14, !llvm.loop !22
}
...
define internal void @_GLOBAL__sub_I_perf_test.cpp() #9 section ".text.startup" {
entry:
