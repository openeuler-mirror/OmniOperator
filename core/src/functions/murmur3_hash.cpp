...
extern "C" {
INLINE int32_t RotateLeft(int32_t i, int8_t distance)
{
    return (i << distance) | (static_cast<uint32_t>(i) >> (MM3_BITS_INT - distance));
}

INLINE int32_t MixK1(int32_t k1)
{
    k1 *= MM3_C1;
...
INLINE int32_t MixH1(int32_t h1, int32_t k1)
{
    h1 ^= k1;
...
INLINE int32_t Fmix(int32_t h1, int32_t length)
{
    h1 ^= length;
...
INLINE int32_t ReverseBytes(int32_t x)
{
...
INLINE int32_t HashBytesByInt(const string base, int32_t lengthInBytes, int32_t seed)
{
    int32_t h1 = seed;
...
INLINE int32_t HashInt(int32_t input, uint32_t seed)
{
...
INLINE int32_t HashLong(int64_t input, int32_t seed)
{
...
INLINE int32_t HashUnsafeBytes(const string base, int32_t lengthInBytes, int32_t seed)
{
...
INLINE int32_t Mm3Int32(int32_t val, bool isNull, int32_t seed)
{
    return HashInt(val * !isNull, seed);
}

INLINE int32_t Mm3Int64(int64_t val, bool isNull, int32_t seed)
{
    return HashLong(val * !isNull, seed);
}

INLINE int32_t Mm3String(const char *val, int32_t valLen, bool isNull, int32_t seed)
{
    string as = string(val, valLen * !isNull);
    return HashUnsafeBytes(as, valLen, seed);
}

INLINE int32_t Mm3Double(double val, bool isNull, int32_t seed)
{
    union {
        int64_t lVal;
        double dVal;
