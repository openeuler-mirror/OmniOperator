...
INLINE uint8_t *GetVarcharFromDictionaryVector(int64_t dictionaryVectorAddr, int32_t index, int32_t *lengthPtr)
{
    auto dictionaryVectorPtr = reinterpret_cast<DictionaryVector *>(dictionaryVectorAddr);
...
INLINE void GetDecimalFromDictionaryVector(int64_t dictionaryVectorAddr, int32_t index, int64_t *outHighPtr,
    uint64_t *outLowPtr)
{
    auto dictionaryVectorPtr = reinterpret_cast<DictionaryVector *>(dictionaryVectorAddr);
