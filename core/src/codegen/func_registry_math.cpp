...
std::vector<Function> MathFunctionRegistry::GetFunctions()
{
    ...
    std::vector<Function> mathFnRegistry = {
        ...
        Function(reinterpret_cast<void *>(Abs<int32_t>), AbsFnStr(), {},
            { OMNI_INT }, OMNI_INT, INPUT_DATA),
        Function(reinterpret_cast<void *>(Abs<int64_t>), AbsFnStr(), {},
            { OMNI_LONG }, OMNI_LONG, INPUT_DATA),
        Function(reinterpret_cast<void *>(Abs<double>), AbsFnStr(), {},
            { OMNI_DOUBLE }, OMNI_DOUBLE, INPUT_DATA),

        // insert native functions for each cast math function
        Function(reinterpret_cast<void *>(CastInt32ToDouble), MathCastFnStr(), {},
            { OMNI_INT }, OMNI_DOUBLE, INPUT_DATA),
        Function(reinterpret_cast<void *>(CastInt64ToDouble), MathCastFnStr(), {},
            { OMNI_LONG }, OMNI_DOUBLE, INPUT_DATA),
        Function(reinterpret_cast<void *>(CastInt32ToInt64), MathCastFnStr(), {},
            { OMNI_INT }, OMNI_LONG, INPUT_DATA),
        Function(reinterpret_cast<void *>(CastInt64ToInt32), MathCastFnStr(), {},
        ...
        Function(reinterpret_cast<void *>(AddDouble), AddFnStr(), {},
            doubleParams, OMNI_DOUBLE, INPUT_DATA),
        ...
        Function(reinterpret_cast<void *>(LessThanDouble), LessThanFnStr(), {},
            doubleParams, OMNI_BOOLEAN, INPUT_DATA),
        ...
        Function(reinterpret_cast<void *>(AddInt64), AddFnStr(), {},
            longParams, OMNI_LONG, INPUT_DATA),
        ...
        Function(reinterpret_cast<void *>(Pmod), PmodFnStr(), {},
            intParams, OMNI_INT, INPUT_DATA),
...
std::vector<Function> MathFunctionRegistryHalfUp::GetFunctions()
{
    std::vector<Function> mathFnRegistry = {
        // insert native functions for each absolute math function
        Function(reinterpret_cast<void *>(CastDoubleToInt64HalfUp), MathCastFnStr(), {},
            { OMNI_DOUBLE }, OMNI_LONG, INPUT_DATA),
        Function(reinterpret_cast<void *>(CastDoubleToInt32HalfUp), MathCastFnStr(), {},
            { OMNI_DOUBLE }, OMNI_INT, INPUT_DATA),
    };
...
std::vector<Function> MathFunctionRegistryDown::GetFunctions()
{
    std::vector<Function> mathFnRegistry = {
        // insert native functions for each absolute math function
        Function(reinterpret_cast<void *>(CastDoubleToInt64Down), MathCastFnStr(), {},
            { OMNI_DOUBLE }, OMNI_LONG, INPUT_DATA),
        Function(reinterpret_cast<void *>(CastDoubleToInt32Down), MathCastFnStr(), {},
            { OMNI_DOUBLE }, OMNI_INT, INPUT_DATA),
    };
