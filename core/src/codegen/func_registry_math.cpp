...
std::vector<Function> MathFunctionRegistry::GetFunctions()
{
    ...
    std::vector<Function> mathFnRegistry = { // insert native functions for each absolute math function
        ...
        Function(reinterpret_cast<void *>(CastInt32ToDouble), castFnStr, {}, { OMNI_VEC_TYPE_INT },
            OMNI_VEC_TYPE_DOUBLE),
        Function(reinterpret_cast<void *>(CastInt64ToDouble), castFnStr, {}, { OMNI_VEC_TYPE_LONG },
            OMNI_VEC_TYPE_DOUBLE),
        ...
        Function(reinterpret_cast<void *>(CastDoubleToInt64), castFnStr, {}, { OMNI_VEC_TYPE_DOUBLE },
            OMNI_VEC_TYPE_LONG),
        Function(reinterpret_cast<void *>(CastDoubleToInt32), castFnStr, {}, { OMNI_VEC_TYPE_DOUBLE },
            OMNI_VEC_TYPE_INT),

        // insert native function for combine hash math function
        Function(reinterpret_cast<void *>(CombineHash), "combine_hash", {}, { OMNI_VEC_TYPE_LONG, OMNI_VEC_TYPE_LONG },
            OMNI_VEC_TYPE_LONG),

        // insert pmod function for project operator support
        Function(reinterpret_cast<void *>(Pmod), "pmod", {}, { OMNI_VEC_TYPE_INT, OMNI_VEC_TYPE_INT },
            OMNI_VEC_TYPE_INT),

        // insert native functions for each round math function
        Function(reinterpret_cast<void *>(Round<int32_t>), roundFnStr, {}, { OMNI_VEC_TYPE_INT, OMNI_VEC_TYPE_INT },
            OMNI_VEC_TYPE_INT),
        Function(reinterpret_cast<void *>(Round<int64_t>), roundFnStr, {}, { OMNI_VEC_TYPE_LONG, OMNI_VEC_TYPE_INT },
            OMNI_VEC_TYPE_LONG),
        Function(reinterpret_cast<void *>(Round<double>), roundFnStr, {}, { OMNI_VEC_TYPE_DOUBLE, OMNI_VEC_TYPE_INT },
            OMNI_VEC_TYPE_DOUBLE)
    };
