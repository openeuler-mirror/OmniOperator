...
std::vector<Function> MathFunctionRegistry::GetFunctions()
{
    ...
    std::vector<Function> mathFnRegistry = { // insert native functions for each absolute math function
        ...
        Function(reinterpret_cast<void *>(CastInt64ToDouble), castFnStr, {}, { OMNI_LONG }, OMNI_DOUBLE),
        ...
        Function(reinterpret_cast<void *>(CastDoubleToInt64), castFnStr, {}, { OMNI_DOUBLE }, OMNI_LONG),
        Function(reinterpret_cast<void *>(CastDoubleToInt32), castFnStr, {}, { OMNI_DOUBLE }, OMNI_INT),
        ...
        Function(reinterpret_cast<void *>(ModulusDouble), modulusFnStr, {}, { OMNI_DOUBLE, OMNI_DOUBLE }, OMNI_DOUBLE),
        ...
        Function(reinterpret_cast<void *>(Round<int32_t>), roundFnStr, {}, { OMNI_INT, OMNI_INT }, OMNI_INT),
