...
std::vector<Function> DateTimeFunctionRegistry::GetFunctions()
{
    std::vector<Function> dateTimeFnRegistry = {
        Function(reinterpret_cast<void *>(UnixTimestampFromStr), "unix_timestamp", {}, { OMNI_VARCHAR, OMNI_VARCHAR },
            OMNI_LONG, INPUT_DATA),
        Function(reinterpret_cast<void *>(UnixTimestampFromDate), "unix_timestamp", {}, { OMNI_DATE32, OMNI_VARCHAR },
            OMNI_LONG, INPUT_DATA),
