...
std::vector<Function> BatchUtilFunctionRegistry::GetFunctions()
{
    std::vector<Function> utilFnRegistry = {
        ...
        Function(reinterpret_cast<void *>(FillDouble), "batch_fill_literal", {}, { OMNI_DOUBLE }, OMNI_DOUBLE,
            INPUT_DATA),
        Function(reinterpret_cast<void *>(FillFloat), "batch_fill_literal", {}, { OMNI_FLOAT }, OMNI_FLOAT,
            INPUT_DATA),
        ...
        Function(reinterpret_cast<void *>(CopyFloat), "batch_copy", {}, { OMNI_FLOAT }, OMNI_FLOAT, INPUT_DATA),
