...
std::vector<Function> DecimalFunctionRegistry::GetFunctions()
{
    ...
    static std::vector<Function> decimalFnRegistry = { Function(reinterpret_cast<void *>(MakeDecimal64), "MakeDecimal",
        ...
        Function(reinterpret_cast<void *>(MakeDecimalLongTo64), "MakeDecimal",
                 {}, { OMNI_LONG, OMNI_INT, OMNI_INT }, OMNI_DECIMAL64),
        ...
        Function(reinterpret_cast<void *>(CastDoubleToDecimal64), "CAST", {}, { OMNI_DOUBLE, OMNI_INT, OMNI_INT}, OMNI_DECIMAL64),
        Function(reinterpret_cast<void *>(DivDec64), "Div_decimal64", {},
                 { OMNI_DECIMAL64, OMNI_DECIMAL64 }, OMNI_DECIMAL64, true),
        ...
        Function(reinterpret_cast<void *>(IsOverflowDecimal64), "IsOverflowDecimal", {}, {OMNI_DECIMAL64, OMNI_INT, OMNI_INT, OMNI_INT, OMNI_INT}, OMNI_BOOLEAN),
        Function(reinterpret_cast<void *>(IsOverflowDecimal128), "IsOverflowDecimal", {}, {OMNI_DECIMAL128, OMNI_INT, OMNI_INT, OMNI_INT, OMNI_INT}, OMNI_BOOLEAN),
        // Decimal UnscaledValue
        Function(reinterpret_cast<void *>(UnscaledValue64), "UnscaledValue", {}, {OMNI_DECIMAL64, OMNI_INT, OMNI_INT}, OMNI_LONG)};
