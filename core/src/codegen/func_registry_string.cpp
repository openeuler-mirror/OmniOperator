...
std::vector<Function> StringFunctionRegistry::GetFunctions()
{
    ...
    std::vector<Function> stringFnRegistry = { // substr functions
        ...
        // concat functions
        Function(reinterpret_cast<void *>(ConcatStrStr), "concat", {}, { OMNI_VARCHAR, OMNI_VARCHAR },
            OMNI_VARCHAR, true),
        Function(reinterpret_cast<void *>(ConcatCharChar), "concat", {}, { OMNI_CHAR, OMNI_CHAR },
            OMNI_CHAR, true),
        Function(reinterpret_cast<void *>(ConcatCharStr), "concat", {}, { OMNI_CHAR, OMNI_VARCHAR },
            OMNI_CHAR, true),
        Function(reinterpret_cast<void *>(ConcatStrChar), "concat", {}, { OMNI_VARCHAR, OMNI_CHAR },
            OMNI_CHAR, true),

        Function(reinterpret_cast<void *>(Like), "LIKE", {}, { OMNI_VARCHAR, OMNI_VARCHAR },
            OMNI_BOOLEAN),
        Function(reinterpret_cast<void *>(CastString), "CAST", {}, { OMNI_VARCHAR }, OMNI_INT),

        Function(reinterpret_cast<void *>(ToUpper), "upper", {}, { OMNI_VARCHAR }, OMNI_VARCHAR,
            true),
        Function(reinterpret_cast<void *>(ToUpperChar), "upper", {}, { OMNI_CHAR }, OMNI_CHAR, true),

        Function(reinterpret_cast<void *>(StrCompare), "compare", {}, { OMNI_VARCHAR, OMNI_VARCHAR },
            OMNI_INT)
    };
