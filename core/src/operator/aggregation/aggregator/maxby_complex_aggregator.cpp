...
template <type::DataTypeId COL2_ID>
void MaxByComplexAggregator<COL2_ID>::AlignAggSchema(VectorBatch *result, VectorBatch *inputVecBatch)
{
...
template <type::DataTypeId COL2_ID>
void MaxByComplexAggregator<COL2_ID>::AlignAggSchemaWithFilter(VectorBatch *result, VectorBatch *inputVecBatch,
...
template <type::DataTypeId COL2_ID>
void MaxByComplexAggregator<COL2_ID>::ProcessAlignAggSchema(VectorBatch *result, BaseVector *originVector,
