 ...
 * Description: regr_count(y, x) - full aggregator (raw / merge / partial / final / spill) in this pair of files.
 */
#ifndef OMNI_RUNTIME_REGR_COUNT_AGGREGATOR_H
#define OMNI_RUNTIME_REGR_COUNT_AGGREGATOR_H
...
class RegrCountAggregator : public TypedAggregator {
public:
    RegrCountAggregator(const DataTypes &inputTypes, const DataTypes &outputTypes, std::vector<int32_t> &channels,
        bool inputRaw, bool outputPartial, bool isOverflowAsNull);
    ~RegrCountAggregator() override = default;
...
#endif // OMNI_RUNTIME_REGR_COUNT_AGGREGATOR_H
