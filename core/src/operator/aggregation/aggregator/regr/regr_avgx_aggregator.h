 ...
 * Description: regr_avgx(y, x) - full aggregator (raw / merge / partial / final / spill) in this pair of files.
 */
#ifndef OMNI_RUNTIME_REGR_AVGX_AGGREGATOR_H
#define OMNI_RUNTIME_REGR_AVGX_AGGREGATOR_H
...
class RegrAvgXAggregator : public TypedAggregator {
public:
    RegrAvgXAggregator(const DataTypes &inputTypes, const DataTypes &outputTypes, std::vector<int32_t> &channels,
        bool inputRaw, bool outputPartial, bool isOverflowAsNull);
    ~RegrAvgXAggregator() override = default;
...
#endif // OMNI_RUNTIME_REGR_AVGX_AGGREGATOR_H
