 ...
 * Description: regr_slope(y, x) — full aggregator (raw / merge / partial / final / spill) in this pair of files.
 */
#ifndef OMNI_RUNTIME_REGR_SLOPE_AGGREGATOR_H
#define OMNI_RUNTIME_REGR_SLOPE_AGGREGATOR_H
...
class RegrSlopeAggregator : public TypedAggregator {
public:
    RegrSlopeAggregator(const DataTypes &inputTypes, const DataTypes &outputTypes, std::vector<int32_t> &channels,
        bool inputRaw, bool outputPartial, bool isOverflowAsNull);
    ~RegrSlopeAggregator() override = default;
...
#endif // OMNI_RUNTIME_REGR_SLOPE_AGGREGATOR_H
