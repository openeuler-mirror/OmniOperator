 ...
 * Description: regr_intercept(y, x) - full aggregator (raw / merge / partial / final / spill) in this pair of files.
 */
#ifndef OMNI_RUNTIME_REGR_INTERCEPT_AGGREGATOR_H
#define OMNI_RUNTIME_REGR_INTERCEPT_AGGREGATOR_H
...
class RegrInterceptAggregator : public TypedAggregator {
public:
    RegrInterceptAggregator(const DataTypes &inputTypes, const DataTypes &outputTypes, std::vector<int32_t> &channels,
        bool inputRaw, bool outputPartial, bool isOverflowAsNull);
    ~RegrInterceptAggregator() override = default;
...
#endif // OMNI_RUNTIME_REGR_INTERCEPT_AGGREGATOR_H
