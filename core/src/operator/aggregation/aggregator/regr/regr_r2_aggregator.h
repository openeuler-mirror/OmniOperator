 ...
 * Description: regr_r2(y, x) - full aggregator (raw / merge / partial / final / spill) in this pair of files.
 */
#ifndef OMNI_RUNTIME_REGR_R2_AGGREGATOR_H
#define OMNI_RUNTIME_REGR_R2_AGGREGATOR_H
...
class RegrR2Aggregator : public TypedAggregator {
public:
    RegrR2Aggregator(const DataTypes &inputTypes, const DataTypes &outputTypes, std::vector<int32_t> &channels,
        bool inputRaw, bool outputPartial, bool isOverflowAsNull);
    ~RegrR2Aggregator() override = default;
...
#endif // OMNI_RUNTIME_REGR_R2_AGGREGATOR_H
