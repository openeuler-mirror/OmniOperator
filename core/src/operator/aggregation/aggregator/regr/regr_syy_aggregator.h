 ...
 * Description: regr_syy(y, x) - full aggregator (raw / merge / partial / final / spill) in this pair of files.
 */
#ifndef OMNI_RUNTIME_REGR_SYY_AGGREGATOR_H
#define OMNI_RUNTIME_REGR_SYY_AGGREGATOR_H
...
class RegrSyyAggregator : public TypedAggregator {
public:
    RegrSyyAggregator(const DataTypes &inputTypes, const DataTypes &outputTypes, std::vector<int32_t> &channels,
        bool inputRaw, bool outputPartial, bool isOverflowAsNull);
    ~RegrSyyAggregator() override = default;
...
#endif // OMNI_RUNTIME_REGR_SYY_AGGREGATOR_H
