...
template class CollectSetAggregator<OMNI_DATE32, OMNI_DATE32>;
template class CollectSetAggregator<OMNI_DATE64, OMNI_DATE64>;
template class CollectSetAggregator<OMNI_TIMESTAMP, OMNI_TIMESTAMP>;
