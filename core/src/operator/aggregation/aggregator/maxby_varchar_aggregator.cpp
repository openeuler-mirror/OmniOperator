...
template <DataTypeId COL1_ID, DataTypeId COL2_ID>
void MaxByVarcharAggregator<COL1_ID, COL2_ID>::AlignAggSchema(VectorBatch *result, VectorBatch *inputVecBatch)
{
    MinMaxByAlignAggSchema<COL1_ID, COL2_ID>(result, inputVecBatch, channels, inputRaw);
}

template <DataTypeId COL1_ID, DataTypeId COL2_ID>
void MaxByVarcharAggregator<COL1_ID, COL2_ID>::AlignAggSchemaWithFilter(VectorBatch *result,
