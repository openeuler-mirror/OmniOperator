...
template <int32_t sortAscending> static int64_t ALWAYS_INLINE GetSmallest(int64x2_t smallestVec)
{
...
template <int32_t sortAscending> static int64_t ALWAYS_INLINE GetLargest(int64x2_t largestVec)
{
...
template <int32_t sortAscending> static uint64x2_t ALWAYS_INLINE Compare(int64x2_t vec0, int64x2_t vec1)
{
    if constexpr (sortAscending == 0) {
    ...
    int64_t *valueBuf, uint64_t *addrBuf, int64x2_t &smallestVec, int64x2_t &largestVec)
{
    ...
    int32_t consumedL = PartitionToMultipleOfUnroll<sortAscending>(valueStart, addressStart, num, pivotVec, valueBuf,
    ...
    if (num != 0) {
        ...
        while (valueReadL != valueReadR) {
            ...
            StoreLeftRight4<sortAscending>(valueStart, pivotVec, curValueVec0, curValueVec1, curValueVec2, curValueVec3,
                addressStart, curAddrVec0, curAddrVec1, curAddrVec2, curAddrVec3, writeL, remaining, smallestVec,
                largestVec);
        }

        StoreLeftRight4<sortAscending>(valueStart, pivotVec, leftValueVec0, leftValueVec1, leftValueVec2, leftValueVec3,
            addressStart, leftAddrVec0, leftAddrVec1, leftAddrVec2, leftAddrVec3, writeL, remaining, smallestVec,
            largestVec);
        StoreLeftRight4<sortAscending>(valueStart, pivotVec, rightValueVec0, rightValueVec1, rightValueVec2,
    ...
    uint64_t *addrBuf, bool chooseAvg, int64_t avg)
{
    ...
    int32_t partitionIdx = PartitionWithSIMD<sortAscending>(values, addresses, from, to, pivotVal, valueBuf, addrBuf,
        smallestVec, largestVec);
