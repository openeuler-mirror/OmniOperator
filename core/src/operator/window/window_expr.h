...
public:
    WindowWithExprOperatorFactory(const type::ContainerDataTypePtr &sourceTypes, int32_t *outputCols, int32_t outputColsCount,
        ...
        const type::ContainerDataTypePtr &outputDataTypes, const std::vector<omniruntime::expressions::Expr *> &argumentKeys,
    ...
    static WindowWithExprOperatorFactory *CreateWindowWithExprOperatorFactory(const type::ContainerDataTypePtr &sourceTypes,
...
public:
    WindowWithExprOperator(type::ContainerDataTypePtr sourceTypes, std::vector<int32_t> &argumentChannels,
