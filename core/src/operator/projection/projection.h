...
using ProjFunc = int32_t (*)(int64_t const *, int32_t, int64_t, int32_t *, int32_t, int64_t const *, int64_t const *, bool *, int32_t *);

namespace omniruntime {
namespace op {
using namespace vec;
using RowProjFunc = void *(*)(int64_t *, int64_t *, int64_t *, int32_t);
