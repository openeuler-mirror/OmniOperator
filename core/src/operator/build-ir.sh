...
clang++-12 -S -O3 -emit-llvm -fno-discard-value-names -I/usr/include/llvm-12/ -I/usr/include/llvm-c-12/ $PWD/aggregator/aggregator.cpp $PWD/sort/sort.h $PWD/sort/sort.cpp $PWD/aggregator/hash_groupby.cpp $PWD/../memory/memory_pool.cpp
