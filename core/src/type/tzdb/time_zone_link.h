...
public:
    [[nodiscard]] explicit time_zone_link(std::string_view __name, std::string_view __target)
...
[[nodiscard]] inline bool operator==(const time_zone_link &__x, const time_zone_link &__y) noexcept
{
