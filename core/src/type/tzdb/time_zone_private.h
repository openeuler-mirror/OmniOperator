...
public:
    ...
    [[nodiscard]] std::vector<omniruntime::tzdb::__continuation> &__continuations()
    {
        return __continuations_;
    }

    [[nodiscard]] const std::vector<omniruntime::tzdb::__continuation> &__continuations() const
    {
        return __continuations_;
    }
...
private:
    ...
    // the vector.
    std::vector<__continuation> __continuations_;
