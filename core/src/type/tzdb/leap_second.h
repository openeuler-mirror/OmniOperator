...
class leap_second {
public:
    [[nodiscard]] explicit constexpr leap_second(date::sys_seconds __date, std::chrono::seconds __value)
...
private:
    ...
    friend constexpr bool operator==(const leap_second &__x, const leap_second &__y)
    {
    ...
    friend constexpr bool operator==(const leap_second &__x, const date::sys_time<_Duration> &__y)
    {
        return __x.date() == __y;
    }
    ...
    template <class _Duration>
    friend constexpr bool operator<(const date::sys_time<_Duration> &__x, const leap_second &__y)
    {
        return __x < __y.date();
    }
