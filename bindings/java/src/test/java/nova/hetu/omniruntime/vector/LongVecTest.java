...
public class LongVecTest
{
            ...
            throws Exception
    {
        ...
        assertEquals(vec1.getSize(), 1024, "Size is expected to be 1024");
        ...
        assertEquals(vec2.getSize(), 1024, "Size is expected to be 1024");
    ...
    public void testSlice()
    {
        ...
        LongVec slice2 = vec1.slice(0, vec1.getSize());
...
//    }
    ...
    public void testZeroSizeAllocate()
    {
        ...
        v1.getValues().asLongBuffer().put(values, 0, values.length);
        v1.close();
    }
}
