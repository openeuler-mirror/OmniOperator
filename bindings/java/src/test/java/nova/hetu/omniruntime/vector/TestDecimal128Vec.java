...
public class TestDecimal128Vec {
    ...
    public void testNewVector() {
        Decimal128Vec vec = new Decimal128Vec(256, 10, 2);
        ...
        assertEquals(((Decimal128VecType) (vec.getType())).getPrecision(), 10);
        assertEquals(((Decimal128VecType) (vec.getType())).getScale(), 2);
        vec.close();
    }
    ...
    public void testPutValues() {
        ...
        Decimal128Vec vec1 = new Decimal128Vec(values.length / 2, 10, 2);
        ...
        Decimal128Vec vec2 = new Decimal128Vec(values.length / 2, 10, 2);
    ...
    public void testCopyPositions() {
        Decimal128Vec originalVector = new Decimal128Vec(4, 10, 2);
    ...
    public void testZeroSizeAllocate() {
        Decimal128Vec v1 = new Decimal128Vec(0, 10, 2);
