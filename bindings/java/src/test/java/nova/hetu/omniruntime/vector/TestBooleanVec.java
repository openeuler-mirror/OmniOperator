...
import static nova.hetu.omniruntime.type.DataType.DataTypeId.OMNI_DATA_TYPE_BOOLEAN;
...
public class TestBooleanVec {
    ...
    public void testNewVector() {
        ...
        assertEquals(vector1.getDataType().getId(), OMNI_DATA_TYPE_BOOLEAN);
        vector1.close();
        ...
        assertEquals(vector2.getDataType().getId(), OMNI_DATA_TYPE_BOOLEAN);
        vector2.close();
    }
