...
public class OmniFilterTest
{
    ...
    public void testUnsupportedFilter()
    {
        ...
        Assert.assertFalse(context.isFilterSupported());
    }
    ...
    public void testFilter1()
    {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            Assert.assertEquals(selected_rows.length, 472);
            Assert.assertEquals(selected_rows[0], 0);
            Assert.assertEquals(selected_rows[471], 471);
        }
    }
    ...
    public void testFilter2()
    {
        ...
        for (int i = 0; i < rowCount; i++) {
            Assert.assertEquals(selected_rows.length, rowCount);
        }
    }
