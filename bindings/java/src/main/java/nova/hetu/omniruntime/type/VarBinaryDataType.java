 ...
 * @since 2021-08-05
 */
public class VarBinaryDataType extends DataType {
    /**
     ...
     */
    protected VarBinaryDataType(int width, DataTypeId dataTypeId) {
        super(dataTypeId);
        this.width = width;
    }
    ...
    public boolean equals(Object obj) {
        ...
        VarBinaryDataType other = (VarBinaryDataType) obj;
