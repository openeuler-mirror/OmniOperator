...
//                LongVec omnivec = new LongVec(sampleData.length);
                LongVec omnivec = new LongVec(10000000);

//                System.out.println("address: "+(omnivec.getAddress()));
...
//            long[] heapvec = benchmarkData.longValues;
            ...
            for (int loopIdx = 0; loopIdx < setLoopCount; loopIdx++) {
                long[] heapvec = new long[sampleData.length];
                for (int idx = 0; idx < ROWS; idx++) {
