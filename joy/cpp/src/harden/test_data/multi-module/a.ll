...
@.str = private unnamed_addr constant [12 x i8] c"I am caller\00", align 1

; Function Attrs: uwtable mustprogress
define dso_local i32 @_Z6callerv() local_unnamed_addr #0 {
entry:
  %call = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([12 x i8], [12 x i8]* @.str, i64 0, i64 0))
  %call1 = tail call i32 @_Z6calleev()
  ret i32 %call1
}
...
declare dso_local i32 @_Z6calleev() local_unnamed_addr #2
