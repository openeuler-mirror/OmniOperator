; ModuleID = 'func_w_param_overwrite.cpp'
source_filename = "func_w_param_overwrite.cpp"
...
define dso_local i32 @_Z7preloopPiS_i(i32* nocapture readnone %row_data, i32* nocapture readnone %y, i32 %z) local_unnamed_addr #0 {
cleanup:
  %call = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([10 x i8], [10 x i8]* @.str, i64 0, i64 0), i32 3)
  %call2 = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([10 x i8], [10 x i8]* @.str.1, i64 0, i64 0), i32 0, i32 1)
  %call2.1 = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([10 x i8], [10 x i8]* @.str.1, i64 0, i64 0), i32 1, i32 2)
  ret i32 3
}
