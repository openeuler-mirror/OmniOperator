//
// Created by kkrazy on 2021-03-26.
//

#include "HammerConfig.h"
...
void HammerConfig::init_func_pass() {
...
void HammerConfig::init_module_pass() {
...
void HammerConfig::populate(legacy::FunctionPassManager &FPM, legacy::PassManager &MPM) {
