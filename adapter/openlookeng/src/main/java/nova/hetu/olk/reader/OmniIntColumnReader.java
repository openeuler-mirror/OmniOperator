 ...
 * @since 20210630
 */
public class OmniIntColumnReader extends IntegerColumnReader {
    /**
     * Instantiates a new Omni int column reader.
     *
     * @param type the type
    ...
    protected Block readNonNullBlock() throws IOException {
        ...
        return new IntArrayOmniBlock(nextBatchSize, Optional.empty(), values);
    }
    ...
    private Block intReadNullBlock(boolean[] isNull, int nonNullCount) throws IOException {
        ...
        return new IntArrayOmniBlock(nextBatchSize, Optional.of(isNull), result);
    }
}
