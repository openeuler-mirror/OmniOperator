...
public class LookupJoinOmniOperators {
    ...
    public static OperatorFactory innerJoin(
        ...
        return createOmniJoinOperatorFactory(
                operatorId,
                planNodeId,
                lookupSourceFactory,
                probeTypes,
                ...
                LookupJoinOperators.JoinType.INNER,
                totalOperatorsCount,
    ...
    public static OperatorFactory probeOuterJoin(
        ...
        return createOmniJoinOperatorFactory(
                ...
                probeHashChannel,
                probeOutputChannels.orElse(rangeList(probeTypes.size())),
                LookupJoinOperators.JoinType.PROBE_OUTER,
                totalOperatorsCount,
                hashBuilderOmniOperatorFactory);
    }
    ...
    public static OperatorFactory lookupOuterJoin(
        ...
        return createOmniJoinOperatorFactory(
                ...
                probeHashChannel,
                probeOutputChannels.orElse(rangeList(probeTypes.size())),
                LookupJoinOperators.JoinType.LOOKUP_OUTER,
                totalOperatorsCount,
                hashBuilderOmniOperatorFactory);
    }
    ...
    public static OperatorFactory fullOuterJoin(
        ...
        return createOmniJoinOperatorFactory(
                ...
                probeHashChannel,
                probeOutputChannels.orElse(rangeList(probeTypes.size())),
                LookupJoinOperators.JoinType.FULL_OUTER,
                totalOperatorsCount,
                hashBuilderOmniOperatorFactory);
    }
    ...
    private static OperatorFactory createOmniJoinOperatorFactory(
            int operatorId,
            PlanNodeId planNodeId,
        ...
        List<Type> probeOutputChannelTypes =
                probeOutputChannels.stream().map(probeTypes::get).collect(toImmutableList());

        return new LookupJoinOmniOperator.LookupJoinOmniOperatorFactory(
                operatorId,
                planNodeId,
