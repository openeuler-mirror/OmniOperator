 ...
 * @since 20210630
 */
public class TopNOmniOperator implements Operator {
     ...
     * @since 20210630
     */
    public static class TopNOmniOperatorFactory implements OperatorFactory {
        ...
        public Operator createOperator(DriverContext driverContext) {
            ...
            OmniOperator omniOperator = omniTopNOperatorFactory.createOperator();
