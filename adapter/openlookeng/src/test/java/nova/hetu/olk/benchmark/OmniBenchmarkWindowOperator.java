 ...
 */
package nova.hetu.olk.benchmark;
...
import static nova.hetu.olk.benchmark.OmniBenchmarkWindowOperator.Context.ROWS_PER_PAGE;
import static nova.hetu.olk.benchmark.OmniBenchmarkWindowOperator.Context.TOTAL_PAGES;
...
@Fork(3)
public class OmniBenchmarkWindowOperator
{
    private static final int WARM_ITERATIONS = 5;
    private static final int MEASUREMENT_ITERATIONS = 10;
    private static final int MEASUREMENT_TIME = 2;
    ...
    public static class Context
    {
        ...
        private List<Page> generateTestData()
        {
            ...
            return transferToOffHeapPages(VecAllocator.GLOBAL_VECTOR_ALLOCATOR, pagesBuilder.build());
        }
    ...
    @Benchmark
    public List<Page> benchmark(OmniBenchmarkWindowOperator.Context context)
    {
    ...
    {
        OmniBenchmarkWindowOperator.Context context = new OmniBenchmarkWindowOperator.Context();
            ...
            throws RunnerException
    {
        Options options = new OptionsBuilder()
                ...
                .include(".*" + OmniBenchmarkWindowOperator.class.getSimpleName() + ".*")
