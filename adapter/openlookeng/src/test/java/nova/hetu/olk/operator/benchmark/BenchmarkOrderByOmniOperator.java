...
public class BenchmarkOrderByOmniOperator {
    ...
    public static class BenchmarkContext {
        ...
        public final int TOTAL_PAGES = 100;
        public final int ROWS_PER_PAGE = 10000;
        ...
        private static final Map<String, List<Integer>> SORT_CHANNELS =
                ...
                .put("group10", ImmutableList.of(0, 1, 2, 3, 4))
                .build();

        private static final Map<String, List<SortOrder>> SORT_ORDERS =
                new ImmutableMap.Builder<String, List<SortOrder>>()
                ...
                .put("group10", ImmutableList.of(DESC_NULLS_FIRST, ASC_NULLS_FIRST, ASC_NULLS_FIRST,
        ...
        @Param({"false", "true"})
        boolean dictionaryBlocks = false;
        ...
        public void setup() {
            ...
            pages = generateTestData(totalChannels);
            ...
            operatorFactory = OrderByOmniOperator.OrderByOmniOperatorFactory.createOrderByOmniOperatorFactory(
                    0,
                    new PlanNodeId("test"),
                    totalChannels,
                    outputChannels,
        ...
        private List<Page> generateTestData(List<Type> totalChannels) {
            List<Page> pages = buildPages(totalChannels, dictionaryBlocks);
    ...
    public void verify() {
        ...
        List<Page> outputPages = orderBy(context);
        assertEquals(context.pages.stream().mapToInt(Page::getPositionCount).sum(), outputPages.stream().mapToInt(Page::getPositionCount).sum());
        context.cleanup();
    }
    ...
    public static void main(String[] args) throws RunnerException {
        Options options = new OptionsBuilder()
                ...
                .include(".*" + BenchmarkOrderByOmniOperator.class.getSimpleName() + ".*")
                .build();
