...
public class BenchmarkHashJoinOmniOperators {
    ...
    private static final LookupJoinOmniOperators LOOKUP_JOIN_OMNI_OPERATORS = new LookupJoinOmniOperators();
    ...
    public static class BuildContext {
        ...
        public TaskContext createTaskContext() {
            TaskContext testingTaskContext =
                    TestingTaskContext.createTaskContext(
                            executor, scheduledExecutor, TEST_SESSION, new DataSize(4, GIGABYTE));
            VecAllocatorHelper.setVectorAllocatorToTaskContext(
                    testingTaskContext, VecAllocator.GLOBAL_VECTOR_ALLOCATOR);
        ...
        public List<Page> getBuildPages() {
            return getSlicedPages(buildPages);
        }
        ...
        protected void initializeBuildPages() {
            ...
            buildPages = transferToOffHeapPages(VecAllocator.GLOBAL_VECTOR_ALLOCATOR, buildPages);
        }
        ...
        protected List<Page> getSlicedPages(List<Page> pages) {
    ...
    public static class JoinContext extends BuildContext {
        ...
        protected OperatorFactory lookupJoinOmniOperatorFactory;
        ...
        public void setup() {
            ...
            try {
                lookupSourceFactory = new BenchmarkHashJoinOmniOperators().benchmarkBuildHash(this, false);
            } catch (Exception e) {
                e.printStackTrace();
            }
        ...
        public List<Page> getProbePages() {
            return getSlicedPages(probePages);
        }
        ...
        protected void initializeProbePages() {
            ...
            probePages = transferToOffHeapPages(VecAllocator.GLOBAL_VECTOR_ALLOCATOR, probePages);
        }
    }
    ...
    private JoinBridgeManager<PartitionedLookupSourceFactory> benchmarkBuildHash(
        ...
        JoinBridgeManager<PartitionedLookupSourceFactory> lookupSourceFactoryManager =
                JoinBridgeManager.lookupAllAtOnce(
                        new PartitionedLookupSourceFactory(
                                ...
                                false));
        HashBuilderOmniOperatorFactory hashBuilderOmniOperatorFactory =
                new HashBuilderOmniOperatorFactory(
                        ...
                        1);
        if (isBuildHash) {
            LOOKUP_JOIN_OMNI_OPERATORS.innerJoin(
            ...
            joinContext.lookupJoinOmniOperatorFactory =
                    LOOKUP_JOIN_OMNI_OPERATORS.innerJoin(
                            HASH_JOIN_OPERATOR_ID,
                            TEST_PLAN_NODE_ID,
                            lookupSourceFactoryManager,
        ...
        Operator operator = hashBuilderOmniOperatorFactory.createOperator(driverContext);
    ...
    public List<Page> benchmarkJoinHash(JoinContext joinContext) throws Exception {
        ...
        Operator joinOperator = joinContext.lookupJoinOmniOperatorFactory.createOperator(driverContext);
    ...
    public static void main(String[] args) throws RunnerException {
        Options options =
                new OptionsBuilder()
                        ...
                        .include(".*" + BenchmarkHashJoinOmniOperators.class.getSimpleName() + ".*")
                        .build();
