...
public class BenchmarkOrderByOlkOperator {
    ...
    public static class BenchmarkContext {
        ...
        public void setup() {
            ...
            operatorFactory = new OrderByOperator.OrderByOperatorFactory(
                    0,
                    new PlanNodeId("test"),
                    totalChannels,
                    outputChannels,
        ...
        private List<Page> generateTestData(List<Type> totalChannels) {
            return buildPages(totalChannels, dictionaryBlocks);
        }
    ...
    public static void main(String[] args) throws RunnerException {
        Options options = new OptionsBuilder()
                ...
                .include(".*" + BenchmarkOrderByOlkOperator.class.getSimpleName() + ".*")
                .build();
