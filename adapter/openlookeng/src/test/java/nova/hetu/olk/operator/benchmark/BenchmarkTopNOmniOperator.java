...
//                "group2", ImmutableList.of(DESC_NULLS_LAST, ASC_NULLS_FIRST,DESC_NULLS_LAST, ASC_NULLS_FIRST));
        ...
        private void createOperatorFactoryAndGenerateTestData() {
            ...
            operatorFactory = new TopNOmniOperator.TopNOmniOperatorFactory(
                    0,
                    new PlanNodeId("test"),
                    inputTypes,
            ...
            throws RunnerException
    {
        ...
        Options options = new OptionsBuilder()
                ...
                .include(".*" + BenchmarkTopNOmniOperator.class.getSimpleName() + ".*")
                //.result("resultomni.csv").resultFormat(ResultFormatType.CSV)
                .build();
