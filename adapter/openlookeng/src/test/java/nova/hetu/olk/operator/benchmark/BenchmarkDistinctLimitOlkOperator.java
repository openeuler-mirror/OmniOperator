...
public class BenchmarkDistinctLimitOlkOperator {
    ...
    public static class BenchmarkContext {
        ...
        private void createOperatorFactoryAndGenerateTestData() {
            ...
            operatorFactory = new DistinctLimitOperator.DistinctLimitOperatorFactory(0, new PlanNodeId("test"),
                    inputTypes, distinctChannels, Long.parseLong(limit), Optional.empty(),
